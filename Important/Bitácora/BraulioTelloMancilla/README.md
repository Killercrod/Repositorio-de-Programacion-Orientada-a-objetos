...
## About the meetings 🎞️
The meetings will be every thursday one and a half hours, is most for see what we have done already and what shoould be done in the next week, so is more for organization than for working, because the work is individual each one work on their home and if there is a problem we talk about it on the group chat.
...
---
  ...
  And finally i made the Class Diagram together with my partner Omar Chim. 
  </details>
