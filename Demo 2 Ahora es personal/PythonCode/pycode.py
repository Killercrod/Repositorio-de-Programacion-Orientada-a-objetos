...
def procesar_imagen_completa(ruta_imagen):
    ...
    if ancho != 1280 or alto != 740:
        imagen = cv2.resize(imagen, (1280, 740))
        print(f"Imagen redimensionada a 1280x740 (original: {ancho}x{alto})")
    
    # Definir ROIs (regiones de interés) - mismas coordenadas que en modo cámara
    # ROI para NOMBRE (Verde)
    roi_nombre = imagen[280:280+85, 530:530+160]
    
    # ROI para CURP (Azul)
    roi_curp = imagen[480:480+30, 500:500+250]
